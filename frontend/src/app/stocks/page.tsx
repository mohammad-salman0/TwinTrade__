...
export default function StocksPage() {
  ...
  const nonHalalOnPage = stocks.filter(
    (s) => s.halalStatus === "Non-Halal",
  ).length;

  const summaryStats = [
    {
      label: "Total Stocks",
      value: pagination?.totalStocks ?? "—",
    ...
    {
      label: "Non-Halal (page)",
      value: nonHalalOnPage,
      accent: "var(--down)",
      icon: ShieldOff,
    },
    {
      ...
      <DashboardLayout>
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          <div>
            ...
            >
              Explore NIFTY 500 stocks with halal screening and live market
              updates.
            </p>
            <p
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                background: halalOnly ? "var(--up-bg)" : "var(--bg-surface)",
                color: halalOnly ? "var(--up)" : "var(--text-secondary)",
                border: `1.5px solid ${halalOnly ? "var(--up-border)" : "var(--border)"}`,
              }}
            >
              <ShieldCheck size={14} />
              {halalOnly ? "Halal Only ✓" : "All Stocks"}
            </button>
          </div>
              ...
              >
                <p style={{ fontSize: 13, color: "var(--text-muted)" }}>
                  ...
                  {pagination && (
                    <>
                      {" "}
                      of {pagination.totalStocks} stocks · page{" "}
            ...
            >
              <button
                ...
                style={{
                  ...
                  border: "1px solid var(--border)",
                  color:
                    page <= 1 ? "var(--text-faint)" : "var(--text-secondary)",
                }}
              >
                    ...
                    p === "..." ? (
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: "1px solid",
                          borderColor:
                            p === page ? "var(--accent-teal)" : "var(--border)",
                          background:
                            p === page
                              ? "var(--accent-teal)"
                              : "var(--bg-surface)",
