        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          >
            <div>
              ...
              >
                Complete trading history and executed orders.
              </p>
              <p
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              >
                <ArrowUpRight size={13} color="var(--up)" />
                <span
                  style={{ fontSize: 12, fontWeight: 700, color: "var(--up)" }}
                >
                  BUY
                </span>
                <span
              ...
              >
                <ArrowDownRight size={13} color="var(--down)" />
                <span
                  style={{
                    fontSize: 12,
                    fontWeight: 700,
